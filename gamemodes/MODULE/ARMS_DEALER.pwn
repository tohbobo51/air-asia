...
CMD:creategun(playerid, params[])
{
	...
	if(pData[playerid][pFamily] < 0) return Error(playerid, "Kamu bukan anggota Geng / Family.");
...
function LockPick(playerid, gunid, ammo)
{
	...
	if(pData[playerid][pActivityTime] >= 100)
	{
		...
		Info(playerid, "Kamu telah berhasil membuat LockPick.");
		TogglePlayerControllable(playerid, 1);
		InfoTD_MSG(playerid, 8000, "LockPick Created!");
