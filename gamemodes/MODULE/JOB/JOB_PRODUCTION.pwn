...
CMD:sellproduct(playerid, params[])
{
	...
	if(pData[playerid][CarryProduct] == 1)
	{
		...
		Product += 10;
		Server_MinMoney(50000);
		Info(playerid, "Anda menjual 10 bahan makanan dengan harga "GREEN_E"$50000");
	...
	else if(pData[playerid][CarryProduct] == 2)
	{
		...
		Info(playerid, "Anda menjual 10 product baju dengan harga "GREEN_E"$65000");
		pData[playerid][pJobTime] += 480;
	}
	else if(pData[playerid][CarryProduct] == 3)
	{
		...
		Product += 10;
		Server_MinMoney(80000);
		Info(playerid, "Anda menjual 10 product equipment dengan harga "GREEN_E"$80000");
		pData[playerid][pJobTime] += 480;
	}
	return 1;
}
